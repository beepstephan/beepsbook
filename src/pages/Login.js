...
export const Login = () => {
  ...
  async function handleLoginGuest() {
    email.current.value = "beepsstilldoing@gmail.com";
    ...
    <main>
      <section>
        ...
        <form onSubmit={handleLogin}>
          <div className="mb-6">
              <label ref={email} htmlFor="email" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Your email</label>
          ...
          <div className="mb-6">
              <label ref={password} htmlFor="password" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Your password</label>
